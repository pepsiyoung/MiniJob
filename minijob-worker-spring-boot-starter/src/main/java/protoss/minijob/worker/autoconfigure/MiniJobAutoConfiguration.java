...
import core.JobDefinitionContainer;
...
//    }
    ...
    @Bean
    public JobController jobController(LocalJobExecutor localJobExecutor) {
        return new JobController(localJobExecutor);
    }

    @Bean
    public JobDefinitionContainer jobDefinitionContainer() {
        return new JobDefinitionContainer();
    }

    @Bean
    public LocalJobExecutor localJobExecutor() {
...
//            Map<String, Object> beans = applicationContext.getBeansWithAnnotation(MiniJobHandler.class);
